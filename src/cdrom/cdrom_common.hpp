...
namespace festation {
    ...
    inline constexpr auto convertMSFtoLDA(uint8_t minutes, uint8_t seconds, uint8_t sector) -> uint32_t
    {
    ...
    inline constexpr auto convertMSFtoLDA(const MSFFormat& msf) -> uint32_t
    {
